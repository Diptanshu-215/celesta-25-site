  ...
  return (
    <div className="overflow-x-hidden w-full">
      ...
      <div className={`w-full ${styles.background2} py-16 px-4 md:px-20`}>
        <section className="max-w-7xl mx-auto mb-16 reveal-section">
          <h2 className="text-white text-4xl uppercase text-center mb-8">Events</h2>

          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className={`${styles.card} relative`}>
              <Image src="/images/landing/events-card-1.png" alt="events-1" width={600} height={700} className="w-full h-auto" />
              <div className={`${styles.cardMeta}`}>
                <h3 className="uppercase font-bold">Drones</h3>
                <p className="text-xs">Description Description Description</p>
              </div>
            </div>

            <div className={`${styles.card} relative`}>
              <Image src="/images/landing/events-card-2.png" alt="events-2" width={600} height={700} className="w-full h-auto" />
              <div className={`${styles.cardMeta}`}>
                <h3 className="uppercase font-bold">Drones</h3>
                <p className="text-xs">Description Description Description</p>
              </div>
            ...
            <div className={`${styles.card} relative`}>
              <Image src="/images/landing/events-card-3.png" alt="events-3" width={600} height={700} className="w-full h-auto" />
              <div className={`${styles.cardMeta}`}>
                <h3 className="uppercase font-bold">Drones</h3>
                <p className="text-xs">Description Description Description</p>
              </div>
        ...
        <section className="max-w-7xl mx-auto mb-16 reveal-section text-center">
          <h2 className="text-white text-4xl uppercase mb-8">Official Merchandise</h2>
          <div className="flex justify-center items-center gap-6">
            <Image src="/images/landing/merch-front.png" alt="merch-front" width={220} height={220} className="inline-block" />
            <Image src="/images/landing/merch-side.png" alt="merch-side" width={220} height={220} className="inline-block" />
            <Image src="/images/landing/merch-back.png" alt="merch-back" width={220} height={220} className="inline-block" />
          </div>
        </section>

        <section className="max-w-7xl mx-auto mb-16 reveal-section">
    <h2 className="text-white text-4xl uppercase mb-6 text-center">CELESTA: Glimpse</h2>
    ...
    <div className={`${styles.glimpseFrame} mx-auto mb-8 relative group`}>
      ...
      >
        {isMuted ? (
          <>
            <span className="text-lg">🔇</span> <span className="text-sm font-semibold tracking-wide">UNMUTE</span>
          </>
        ) : (
          <>
            <span className="text-lg">🔊</span> <span className="text-sm font-semibold tracking-wide">MUTE</span>
          </>
        )}
      </button>
    </div>

    <h3 className="text-white text-3xl uppercase text-center mb-4">Theme</h3>
